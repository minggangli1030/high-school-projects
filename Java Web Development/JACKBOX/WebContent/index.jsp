...
<body>
	...
	<section class="header">
		...
		<div class="text-box">
			<h1>JACKBOX</h1>
			<p>
				JACKBOX is an all Chinese League of Legends esports team from China.
				</br> We joined LPL in 2023 and have won 13 LPL championships and 7
				international titles so far, including 3 times at Worlds and 3 times
				at MSI. </br> Since 2040, our own esports stadium "Jack in the Box" in
				Shenzhen has been put into use.
