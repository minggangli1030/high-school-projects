...
public class OurPoint_Orbiter_Copy {
	...
	// constructor...
	public OurPoint_Orbiter_Copy(Point p) {
		...
		radiusSize = (int) (Math.random() * 100) + 15;
	}
	...
	public void movePoint() {
		...
		if (getDistance(xyCoords.x, xyCoords.y, startX, startY) >= radiusSize) {
	...
	public int getDistance(int x1, int y1, int x2, int y2) {
		...
		int dist = (int) (Math.sqrt(((x2 - x1) * (x2 - x1) * 1.00) + ((y2 - y1) * (y2 - y1) * 1.00)));
	...
	public void drawOuterCircle(Graphics g) {
		...
		g2.drawOval(startX - radiusSize, startY - radiusSize, radiusSize * 2, radiusSize * 2);
